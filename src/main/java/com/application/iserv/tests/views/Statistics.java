...
import com.application.iserv.tests.components.DataSeriesItemWithRadius;
...
import com.application.iserv.tests.layout.size.Uniform;
import com.application.iserv.tests.util.*;
import com.application.iserv.tests.util.css.Position;
import com.application.iserv.tests.util.css.*;
...
public class Statistics extends ViewFrame {
	...
	private Component createPayments() {
		...
		payments.setMargin(com.application.iserv.tests.layout.size.Top.L);
	...
	private Component createPaymentChart(Payment.Status status) {
		...
		textContainer.setPosition(com.application.iserv.tests.util.css.Position.ABSOLUTE);
		...
		paymentChart.setPadding(com.application.iserv.tests.layout.size.Bottom.S, com.application.iserv.tests.layout.size.Top.S);
		return paymentChart;
	}
	...
	private Component createTransactions() {
		...
		transactions.setMargin(com.application.iserv.tests.layout.size.Top.XL);
	...
	private Component createReports() {
		...
		reports.setPadding(com.application.iserv.tests.layout.size.Bottom.XL, Left.RESPONSIVE_L);
		return reports;
	}
	...
	private Component createLogs() {
		...
		logs.setPadding(com.application.iserv.tests.layout.size.Bottom.XL, Right.RESPONSIVE_L);
		return logs;
	}
